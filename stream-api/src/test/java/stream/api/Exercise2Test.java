...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (prevAge, nextAge) -> Integer.compare(nextAge, prevAge);
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((prevCustomer, nextCustomer) -> Integer.compare(nextCustomer.getBudget(), prevCustomer.getBudget())).limit(3).map(Customer::getName);
